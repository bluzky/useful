defmodule QueryFilter do
  ...
  ⚠️ Be careful with empty filters, you should prevent it yourself, otherwise it will return all records.

  Example:

    User
    |> filter_by([name: "John", age: 18])
    |> Repo.all
  """

  def filter_by(query, filters) when is_map(filters) or is_list(filters) do
